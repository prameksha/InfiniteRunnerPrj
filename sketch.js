...
var ground, invisiGround, groundImg,groundImage;
...
function preload(){
  ...
  groundImage = loadAnimation("ground real.jpg")
...
function setup(){
 canvas = createCanvas(displayWidth - 20, displayHeight - 150);
  ...
  ground = createSprite(1000,550);
  ground.scale = 1;
  
  ground.addAnimation("ground", groundImage);
  
  invisiGround = createSprite(300,490,600,7);
...
function obstacles(){
  if (frameCount%200 === 0){
    ...
    obstacle = createSprite(620,460,50,50);
